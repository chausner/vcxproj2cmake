...
static class ConfigDependentSettingExtensions
{
    extension(CMakeConfigDependentSetting self)
    {
            ...
            ILogger logger)
        {
            ...
            return new(msbuildSetting, projectConfigurations, self.MSBuildProject, logger);
        }
        ...
        public CMakeConfigDependentSetting Map(
            ...
            ILogger logger)
        {
            return self.Map(mapper, new CMakeConfigDependentSetting(setting, projectConfigurations, self.MSBuildProject, logger), projectConfigurations, logger);
        }
        ...
        public CMakeConfigDependentSetting Map(
            ...
            ILogger logger)
        {
            return self.Map(mapper, new CMakeConfigDependentMultiSetting(setting, projectConfigurations, self.MSBuildProject, logger), projectConfigurations, logger);
        }
        ...
        public static CMakeConfigDependentSetting FromMSBuildSetting(
            ...
            ILogger logger)
        {
            return new CMakeConfigDependentSetting(settings, projectConfigurations, msbuildProject, logger)
    ...
    extension(CMakeConfigDependentMultiSetting self)
    {
        ...
        public static CMakeConfigDependentMultiSetting FromMSBuildSetting(
            ...
            ILogger logger)
        {
            return new CMakeConfigDependentMultiSetting(settings, projectConfigurations, msbuildProject, logger)
                .Map(mapper, projectConfigurations, logger);
        }
